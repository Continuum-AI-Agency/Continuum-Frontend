...
- [x] 10.01 Add email column to permissions and update RLS for team visibility (note: Starting database migration to add email column and update RLS.) (note: Migration file created: supabase/migrations/20260203140000_refactor_permissions.sql. Added email column, backfill logic, and updated RLS for team visibility.)
