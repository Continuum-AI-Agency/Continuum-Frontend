      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        ...
        <div className="bg-slate-950/70 backdrop-blur-xl rounded-3xl border border-white/30 dark:border-white/10 p-12 shadow-2xl">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. User Conduct and Acceptable Use</h2>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Third-Party Integrations</h2>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">7. Disclaimer</h2>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">9. Changes</h2>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              If you have any questions about these Terms, please contact us at: <a href="mailto:legal@continuum.ai" className="text-blue-400 hover:text-blue-300 underline">legal@continuum.ai</a>
            </p>
          </div>
        </div>
      </div>
