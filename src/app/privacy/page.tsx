  ...
  return (
    <div className="min-h-screen bg-slate-950" style={{ backgroundImage: glowGradient }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        ...
        {/* Card */}
        <div className="bg-slate-950/70 backdrop-blur-xl rounded-3xl border border-white/30 dark:border-white/10 p-12 shadow-2xl">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              <strong className="text-white">Usage Data:</strong> We may also collect information on how the Service is accessed and used ("Usage Data"). This Usage Data may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.
            </p>
            <p className="text-gray-300 leading-relaxed mb-6">
              <strong className="text-white">Tracking & Cookies Data:</strong> We use cookies and similar tracking technologies to track the activity on our Service and hold certain information. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service.
            </p>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Data Transfer and Storage</h2>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Disclosure of Data</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">6. Service Providers</h2>
            <p className="text-gray-300 leading-relaxed mb-6">
              We may employ third-party companies and individuals to facilitate our Service ("Service Providers"), to provide the Service on our behalf, to perform Service-related services or to assist us in analyzing how our Service is used. These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.
            </p>

            <h2 className="text-2xl font-bold text-white mt-8 mb-4">7. Your Data Protection Rights</h2>
            <p className="text-gray-300 leading-relaxed mb-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:privacy@continuum.ai" className="text-blue-400 hover:text-blue-300 underline">privacy@continuum.ai</a>
            </p>
          </div>
        </div>
      </div>
