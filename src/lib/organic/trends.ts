...
export const DEFAULT_TRENDS: Trend[] = [
  ...
  },
  {
    ...
    summary:
      'Day-in-the-life content featuring makers, founders, or operators to humanize the brand.',
    momentum: 'rising',
  ...
  },
  {
    ...
    summary:
      'Three-step educational clips that solve a focused customer pain point in under 60 seconds.',
    momentum: 'stable',
  ...
  },
  {
    ...
    summary:
      'Carousel-ready quote snapshots that distill POVs from leadership or strategic partners.',
    momentum: 'stable',
    platforms: ['linkedin', 'instagram'],
  ...
  },
  {
    ...
    summary:
      'LinkedIn Pulse and Instagram Q&A stickers aggregating audience questions for weekly responses.',
    momentum: 'cooling',
    platforms: ['linkedin', 'instagram'],
