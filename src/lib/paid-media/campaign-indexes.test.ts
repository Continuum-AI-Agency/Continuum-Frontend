    ...
    const aggregate = buildCampaignIndexAggregate([
      {
        id: "c1",
        trends: [
          { date: "2026-02-20T00:00:00.000Z", spend: 100, roas: 1, ctr_pct: 2 },
          { date: "2026-02-21T00:00:00.000Z", spend: 80, roas: 2, ctr_pct: 3 },
        ],
      },
      {
        id: "c2",
        trends: [
          { date: "2026-02-20T00:00:00.000Z", spend: 200, roas: 3, ctr_pct: 4 },
          { date: "2026-02-22T00:00:00.000Z", spend: 60, roas: 5, ctr_pct: 6 },
        ],
      },
    ]);
