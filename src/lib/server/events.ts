...
import type { ContinuumEvent, ContinuumEventMap, ContinuumEventName } from '../events/schema';
...
class ContinuumEventBus {
  ...
  subscribeTo<K extends ContinuumEventName>(type: K, listener: ContinuumEventListener<K>) {
...
export function subscribeToContinuumEvents(listener: ContinuumEventListener) {
