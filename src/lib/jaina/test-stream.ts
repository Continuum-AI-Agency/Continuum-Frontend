...
const streamingReport = {
  ...
  campaign_table: [
    { campaign_name: "ANDROID | FEED - App AdvantagePlus - Influencer", status: "ACTIVE", spend: 41551.73, purchases: 56, cpa: 741.99, roas: 1.66, revenue: 69017.95 },
    { campaign_name: "ANDROID | FEED - App AdvantagePlus - 2024", status: "ACTIVE", spend: 55803.54, purchases: 63, cpa: 885.77, roas: 1.71, revenue: 95290.16 },
    { campaign_name: "ANDROID | FEED - App AdvantagePlus - UDF", status: "ACTIVE", spend: 5630.24, purchases: 7, cpa: 804.32, roas: 1.92, revenue: 10818.0 }
  ],
  strategic_analysis: [
    { title: "Efficiency Leader: App AdvantagePlus - Influencer", description: "This campaign is your 'best' when considering a balance of scale and cost..." },
    { title: "High-ROAS Specialist: App AdvantagePlus - UDF", description: "At 1.92 ROAS, this campaign is your most profitable per dollar spent..." },
    { title: "Volume Driver: App AdvantagePlus - 2024", description: "This is your primary revenue engine, generating $95,290.16..." }
  ],
  next_steps: [
    { action: "Scale Influencer Campaign", impact: "High Impact on ROAS", recommendation: "Increase daily budget for the 'Influencer' campaign by 15-20%..." },
    { action: "Audit 2024 Campaign Creatives", impact: "CPA Reduction", recommendation: "Analyze which specific ad sets or creatives in the '2024' campaign are driving the $885 CPA..." },
    { action: "Test UDF Scalability", impact: "Incremental Profit", recommendation: "Gradually increase spend on the 'UDF' campaign..." }
  ]
};
