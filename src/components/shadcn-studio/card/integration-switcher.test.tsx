...
import { IntegrationSwitcher, type IntegrationSwitcherData, type IntegrationSwitcherTab } from "./integration-switcher";
...
describe("IntegrationSwitcher", () => {
  ...
  it("accepts custom tabs and data", () => {
    ...
    render(<IntegrationSwitcher integrations={integrations} data={data} defaultActiveIntegration="beta" />);
