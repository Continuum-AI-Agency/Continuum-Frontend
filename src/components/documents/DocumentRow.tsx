  ...
  return (
    <button
      ...
      className={cn(
        ...
        tone === "success" && "bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/20 dark:text-emerald-400",
        tone === "error" && "bg-rose-500/10 text-rose-600 hover:bg-rose-500/20",
        tone === "progress" && "bg-emerald-500/5 text-emerald-600 cursor-wait dark:text-emerald-400",
