...
const PERSISTED_UI_CARDS = [
  { type: "tool.call", data: { args: {}, toolName: "getBrandIntegrationSummary", toolCallId: "IZSS2shSTAwoPmH9" } },
  {
    type: "tool.result",
    data: { ok: true, result: { code: "edge_fallback_failed", status: "error", summary: "rpc_failed" }, toolName: "getBrandIntegrationSummary", toolCallId: "IZSS2shSTAwoPmH9" },
  },
  { type: "tool.call", data: { args: { limit: 8, query: "pepperoni pizza", threshold: 0.2 }, toolName: "searchMediaLibrary", toolCallId: "HguxwayYEKxhQJXa" } },
  { type: "media.search_results", data: { mode: "text", items: [], query: "pepperoni pizza" } },
  {
    type: "tool.result",
    data: { ok: true, result: { code: "no_matches", status: "warning", summary: "count=0" }, toolName: "searchMediaLibrary", toolCallId: "HguxwayYEKxhQJXa" },
  },
  { type: "tool.call", data: { args: { query: "new pepperoni special pizza launch", relevantAngles: ["Pepperoni Special Launch"] }, toolName: "brandGrounding", toolCallId: "0uy1aAKRLsD3scyw" } },
  { type: "tool.result", data: { ok: true, result: { success: true, brandProfile: [{ text: "Brand Name: Pizza Test" }] }, toolName: "brandGrounding", toolCallId: "0uy1aAKRLsD3scyw" } },
  { type: "ui.plan_status", data: { itemId: "b7c62a25-3021-4634-8e89-4e3753d4bc80", planId: "b041d0bf-7853-4865-a860-19184316fb39", status: "executing" } },
  { type: "tool.call", data: { args: { angle: "Introducing our new Pepperoni Special pizza!" }, toolName: "createPost", toolCallId: "kZ0createPost01" } },
  {
    type: "tool.result",
    data: { ok: true, result: { data: { jobId: "134294d9-1866-455b-af42-f556479b99dc", planId: "b041d0bf-7853-4865-a860-19184316fb39", platform: "instagram", planItemId: "b7c62a25-3021-4634-8e89-4e3753d4bc80" } }, toolName: "createPost", toolCallId: "kZ0createPost01" },
  },
] as const
...
describe("backend response → FE rendering alignment (real persisted ui_cards)", () => {
  ...
  it("reconstructs the thinking trace, plan status, and media results on reload", () => {
    ...
    expect(msg.mediaSearchResults![0]).toMatchObject({ type: "media.search_results", data: { query: "pepperoni pizza" } })
  })
})
