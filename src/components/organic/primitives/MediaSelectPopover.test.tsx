...
mock.module("@/components/library/LibraryFilterBar", () => ({ LibraryFilterBar: () => <div data-testid="filter-bar" /> }))
mock.module("@/lib/creative-assets/assetUrl", () => ({ sanitizeCreativeAssetUrl: (u: string) => u }))
