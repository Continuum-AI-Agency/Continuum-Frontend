...
function AssetTile({ asset, order, onToggle }: { asset: MediaAsset; order: number; onToggle: () => void }) {
              ...
              <p className="text-center text-xs text-muted-foreground/60">
                {query.trim() ? (
                  ...
                  <>
                    ...
                    <span className="text-muted-foreground">Generate, or add media in AI Studio.</span>
                  </>
                )}
              </p>
            </div>
