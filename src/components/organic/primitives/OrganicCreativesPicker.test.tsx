...
describe("OrganicCreativesPicker.handleAttach", () => {
  ...
  it("emits carousel publishingAssets with slideIndex when multiple images are attached", () => {
    const a1 = makeAsset({ id: "a1", storagePath: "s1.jpg", fileName: "s1.jpg", signedUrl: "https://cdn/s1" })
    const a2 = makeAsset({ id: "a2", storagePath: "s2.jpg", fileName: "s2.jpg", signedUrl: "https://cdn/s2" })
