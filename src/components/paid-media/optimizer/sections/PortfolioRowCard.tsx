...
export function PortfolioRowCard({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={cn(
        'flex w-full items-center justify-between gap-3 rounded-xl border border-border/70 bg-card px-4 py-3 text-left transition-colors',
    ...
    >
      <div className="min-w-0">
        ...
        <div className="mt-1 flex flex-wrap items-center gap-1.5 text-xs text-muted-foreground">
          ...
          <Badge variant="teal" className="text-[10px] font-medium">
