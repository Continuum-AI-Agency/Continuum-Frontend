...
import { DailyMetric, TimelineAd, TimelineAdSet, TimelineCampaign, TimelineEvent, TimelineSegment } from '@/types/timeline';
...
export function CampaignRow({
    ...
    const campaignEvents = campaign.ad_sets?.flatMap((adSet) => adSet.ads?.flatMap((ad) => ad.events || []) || []) || [];
