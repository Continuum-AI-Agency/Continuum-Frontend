...
import { ArrowDownIcon, ArrowUpIcon, MinusIcon, ChevronDownIcon, ChevronUpIcon } from "lucide-react";
...
function DeltaGlyph({ tone, size = 10 }: { tone: "positive" | "negative" | "flat"; size?: number }) {
