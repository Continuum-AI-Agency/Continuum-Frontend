        ...
        <>
          {understanding.positioning_thesis ? (
            <div>
              ...
              <p className="text-[13px] leading-snug text-[#0b1220]">{understanding.positioning_thesis}</p>
            </div>
          ) : null}
          {understanding.hypothesis_icp ? (
            <div>
              ...
              <p className="text-[12px] leading-snug text-[#374151]">{understanding.hypothesis_icp}</p>
            </div>
          ) : null}
          {understanding.tonal_signal ? (
            <div>
              ...
              <p className="text-[12px] leading-snug text-[#374151]">{understanding.tonal_signal}</p>
            </div>
          ) : null}
          ...
          {understanding.content_pillars && understanding.content_pillars.length > 0 ? (
            <ChipRow label="Content pillars" values={understanding.content_pillars} variant="teal" />
          ) : null}
