  ...
  return (
    <button
      ...
      className={cn(
        ...
        state === 'done' &&
          'bg-[color-mix(in_srgb,var(--cs-teal,#0daea2)_12%,transparent)] text-[var(--cs-teal,#0daea2)]',
        state === 'active' &&
          'bg-[color-mix(in_srgb,var(--cs-violet,#5a39ff)_12%,transparent)] text-[var(--cs-violet,#5a39ff)]',
