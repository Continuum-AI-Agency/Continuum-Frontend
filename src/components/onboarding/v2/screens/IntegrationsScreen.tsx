...
import { trackOnboardingEvent, type OnboardingEventName } from "@/lib/onboarding/telemetry";
...
export function IntegrationsScreen({ onAdvance }: IntegrationsScreenProps) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-4 py-10 md:px-8">
      <BrandAssetAssigner
        brandId={brandId}
        onTrack={(event, payload) => trackOnboardingEvent(ONBOARDING_EVENT_BY_ASSIGNER_EVENT[event], payload)}
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <HelpPopover label="What does Continuum read from these accounts?">
                ...
                <ul className="space-y-1 text-muted-foreground">
                  <li>
                    <span className="font-medium text-foreground">Meta</span> — ad
                    accounts, pages, and insights from Facebook, Instagram, and
                    Threads.
                  </li>
                  <li>
                    <span className="font-medium text-foreground">Google</span> —
                    Google Ads, YouTube, and DV360 accounts plus performance data.
                  </li>
                  <li>
                    <span className="font-medium text-foreground">TikTok</span> —
                    ad accounts and campaign-level metrics.
                  </li>
                </ul>
        ...
        footer={
          <div className="flex flex-col items-center gap-2 pt-1">
            <Button variant="link" size="sm" onClick={onAdvance} className="text-muted-foreground hover:text-foreground">
              Continue
            </Button>
          </div>
        }
