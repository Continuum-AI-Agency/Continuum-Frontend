...
const ROW_CLASS = "group border-b border-border/50 transition-colors hover:bg-muted/40 last:border-b-0";
      ...
      <Table>
        ...
        <TableBody>
          {isLoading ? (
            ...
            <TableRow className="hover:bg-transparent">
              <TableCell colSpan={totalColumns} className="px-3 py-6 text-center text-xs text-muted-foreground">
            ...
            sortedRows.map((row) => {
              ...
              const dataRow = (
                <tr
                  ...
                  onClick={expandable ? () => setExpandedId((prev) => (prev === id ? null : id)) : undefined}
                >
                  {cells}
                </tr>
              );
