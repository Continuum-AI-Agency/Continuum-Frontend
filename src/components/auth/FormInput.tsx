...
type RootProps = React.ComponentPropsWithoutRef<typeof Input>;
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input
            ...
            ref={ref}
            inputSize="lg"
            className={`w-full transition-all duration-200 ${isPasswordField ? 'pr-10 ' : ''}${
              error
          ...
          {isPasswordField && (
            <Button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors"
