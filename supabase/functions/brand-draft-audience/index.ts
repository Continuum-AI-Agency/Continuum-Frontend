...
// Streams targetAudience via SSE using Gemini
...
serve(async (req: Request) => {
  ...
  const systemInstruction =
    `You are drafting a concise target audience summary using the website as primary source. ` +
    `Output 2-3 sentences plus bullet segments (3-5). Locale: ${lc}.`;
