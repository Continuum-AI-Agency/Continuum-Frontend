...
import { brandGroundingBundleSchema, groundingHitSchema } from './brand-grounding';
...
describe('groundingHitSchema', () => {
  ...
  it('rejects an unknown source', () => {
    expect(groundingHitSchema.safeParse({ source: 'twitter', snippet: 'x' }).success).toBe(false);
  });
});
