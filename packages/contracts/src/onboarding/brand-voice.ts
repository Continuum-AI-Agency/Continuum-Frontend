...
export const brandVoiceSchema = z
  .object({
    ...
    key_messaging: z
      .preprocess(
        coerceStringArray({ maxLen: 420, maxItems: 10 }),
        z.array(z.string().max(420)).max(10),
      )
      .nullable()
      .optional(),
    keywords: z
      .preprocess(
        coerceStringArray({ maxLen: 90, maxItems: 30 }),
        z.array(z.string().min(1).max(90)).max(30),
      )
      .nullable()
      .optional(),
    ...
    core_values: z
      .preprocess(
        coerceStringArray({ maxLen: 180, maxItems: 12 }),
        z.array(z.string().max(180)).max(12),
      )
      .nullable()
      .optional(),
    banned_words: z
    ...
    power_verbs: z
      .preprocess(
        coerceStringArray({ maxLen: 60, maxItems: 22 }),
        z.array(z.string().min(1).max(60)).max(22),
      )
      .nullable()
      .optional(),
  })
